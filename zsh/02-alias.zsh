...
alias     lst='perl $HOME/dev/ls--/ls++ -tr'
alias     lsr='perl $HOME/dev/ls--/ls++ --sort=time -r'
alias  pacman='pacman --color=auto'
alias prename='prename -v'
alias     vim='$HOME/dev/time-spent-in-vim/bin/time-spent-in-vim'
alias    cpan='cpanm'
alias     top='xcolor woldrich 2>/dev/null; htop'
alias     :q!='kill -9 $$'
alias      :q='exit'
alias     die='kill -9 $$'
alias   dmesg='$HOME/dev/Term-ExtendedColor/bin/colored_dmesg|/bin/grep -viP "TCP|ipv6|audit"'
