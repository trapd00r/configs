...
#   asax: ASP.NET application file.
#    asc: ASCII text file.
#    asf: Media player audio-visual file.
#   ashx: ASP.NET HTTP handler file.
#   asmx: SP.NET web services source file.
...
#    cub: Windows installer validation module.
#    cue: Cue sheet file.
...
#    dim: Developer Installation Manifest file.
#    dir: Shockwave file.
...
#    nut: Nutricalc file.
#     nv: NewViews accounting for DOS database file.
#    nv2: NewViews accounting for Windows database file.
#    nzb: Newzbin file.
#      o: Object file.
#    obj: Object file (Windows).
#    obl: InstallScript library file.
#    oca: VB cache file.
#    ocx: ActiveX control.
...
#    ops: Microsoft Outlook Profile Settings file.
...
#    p01: Parity volume file.
#    p02: Parity volume file.
#    p12: Personal Information Exchange file.
#    pab: Microsoft Outlook address book.
#    pak: WAD file.
#paq8o10t: PAQ compressed archive.
#    par: Windows 3.x swap file / Parity index file.
#   par2: RAR archive parity file.
...
#profiler: ANTS Profiler project file.
...
#    rip: RIP script file / Hit'n'Mix Audio file.
...
#    sts: Datapulse - CIM file / MEMMAKER status file.
...
#    wks: Microsoft Works spreadsheet file.
