...
k () {
  ...
  # ----------------------------------------------------------------------------
  # default colors
  K_COLOR_DI="38;5;30"  # di:directory
  K_COLOR_LN="38;5;2"  # ln:symlink
  K_COLOR_SO="38;5;197"  # so:socket
  K_COLOR_PI="38;5;127"  # pi:pipe
  K_COLOR_EX="38;5;66;1"  # ex:executable
  ...
  K_COLOR_TW="38;5;232;48;5;30" # tw:directory writable to others, with sticky bit
  K_COLOR_OW="38;5;235;38;5;139;3" # ow:directory writable to others, without sticky bit
