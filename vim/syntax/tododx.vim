...
syn match  todourl         /URL/
syn match  tododesc        /DESCRIPTION/
...
if !exists("did_todo_syntax_inits")
  ...
  hi link todoclosed tClosed
    hi link closed tClosed
    hi default tClosed ctermfg=65

  hi link todoinprogress tProgress
    hi link inprogress tProgress
    hi default tProgress ctermfg=226

  hi link todourl turl
    hi link inprogress turl
    hi default turl cterm=bold ctermfg=244

  hi link tododesc tdesc
    hi link tododesc tdesc
    hi default tdesc cterm=bold ctermfg=244
