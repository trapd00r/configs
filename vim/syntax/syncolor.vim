...
if &background == "dark"
  ...
  SynColor Constant	term=underline cterm=NONE ctermfg=Magenta ctermbg=NONE 
  SynColor Special	term=bold cterm=NONE ctermfg=LightRed ctermbg=NONE 
  SynColor Identifier	term=underline cterm=bold ctermfg=Cyan ctermbg=NONE 
  SynColor Statement	term=bold cterm=NONE ctermfg=Yellow ctermbg=NONE 
  SynColor PreProc	term=underline cterm=NONE ctermfg=LightBlue ctermbg=NONE 
  SynColor Type		term=underline cterm=NONE ctermfg=LightGreen ctermbg=NONE 
  ...
  SynColor Identifier	term=underline cterm=NONE ctermfg=DarkCyan ctermbg=NONE 
  SynColor Statement	term=bold cterm=NONE ctermfg=Brown ctermbg=NONE 
  SynColor PreProc	term=underline cterm=NONE ctermfg=DarkMagenta ctermbg=NONE 
  SynColor Type		term=underline cterm=NONE ctermfg=DarkGreen ctermbg=NONE 
  SynColor Underlined	term=underline cterm=underline ctermfg=DarkMagenta 
