...
if !exists("did_tasklist_syntax_inits")
  let did_tasklist_syntax_inits = 1

  hi link package tPackage
    hi link package tPackage
    hi default tPackage ctermfg=32 cterm=bold

    hi link category tCategory
    hi link category tCategory
    hi default tCategory ctermfg=220 cterm=bold

  hi link parens tParens
    hi link parens tParens
    hi default tParens ctermfg=226 cterm=bold
