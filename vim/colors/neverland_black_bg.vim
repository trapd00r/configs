...
if &t_Co > 255
  " Setting normal before any other highlight group is a good idea
   ...
   hi Folded          ctermfg=233  ctermbg=240 cterm=reverse
   ...
   hi MatchParen      ctermfg=196 ctermbg=233   cterm=bold
   ...
   hi Search          ctermfg=233 ctermbg=222
   ...
   hi StatusLineNC    ctermfg=233 ctermbg=100
   ...
   hi WarningMsg      ctermfg=197 ctermbg=53   cterm=none
   ...
   hi TabLineSel      ctermfg=220 ctermbg=233
end
