...
if &t_Co > 255
   hi Boolean         ctermfg=240 ctermbg=000 cterm=bold
   hi Character       ctermfg=240 ctermbg=000 cterm=none
   hi Number          ctermfg=239 ctermbg=000 cterm=bold
   hi String          ctermfg=178 ctermbg=000 cterm=none
   hi Conditional     ctermfg=026 ctermbg=000 cterm=bold
   hi Constant        ctermfg=241 ctermbg=000 cterm=bold
   ...
   hi Float           ctermfg=239 ctermbg=000 cterm=bold
   hi FoldColumn      ctermfg=67  ctermbg=016 cterm=none
   hi Folded          ctermfg=67  ctermbg=016 cterm=none
   hi Function        ctermfg=172 ctermbg=000 cterm=bold " sub laleh 
   hi Identifier      ctermfg=225 ctermbg=000 cterm=none " $laleh
   hi Ignore          ctermfg=244 ctermbg=232 cterm=none
   hi IncSearch       ctermfg=193 ctermbg=015 cterm=none
   ...
   hi Operator        ctermfg=028 ctermbg=000 cterm=bold " defined, eq
   ...
   hi Search          ctermfg=220 ctermbg=232 cterm=bold
   ...
   hi Special         ctermfg=220 ctermbg=000 cterm=bold  " \n, /laleh/
