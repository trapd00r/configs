           ...
           int y)
{
	...
	if (DETAIL ("hseparator") || DETAIL ("menuitem") || DETAIL ("slider") || DETAIL("vscale")) {
           ...
           int x)
{
	...
	if (DETAIL ("vseparator") || DETAIL ("toolbar") || DETAIL ("slider") || DETAIL ("hscale")) {
         ...
         int height)
{
	...
	if (DETAIL ("menuitem") && state_type == GTK_STATE_PRELIGHT) {
		...
		width -= 2;
		height -= 2;
	} else if (DETAIL ("slider") || DETAIL ("hscale") || DETAIL ("vscale")) {
		x -= 1;
		y -= 1;
		width += 2;
		height += 2;
